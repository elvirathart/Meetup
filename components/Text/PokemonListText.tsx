...
export const PokemonListText: React.FC = () => {
  return (
    <div className="text">
      <h2 style={{ color: "#1ea7fd" }}>PokemonCheckboxes and PokemonList Components</h2>
        ...
        this means we need to render both components in Storybook. 
        <br />
        We also need to make the logic available to Storybook 
