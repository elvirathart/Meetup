    ...
    <div className="text">
      ...
      <p>
        <strong>
          ...
          <br />- Assert the content after 3 clicks.
        </strong>
        <br />
        <br />
      ...
      <p>
        <strong>
          - Finish the PichuState story by adding a test. The skeleton for the
          story is already there.
          <br />
          - Create a Story for the second state.
          <br />- Create a Story for the third state.
        </strong>
      </p>
      <h3>Add documentation:</h3>
      <p>
        This button has several states and because we now created a story for
        each state it would be nice to document this somewhere. We can add a tag
        to the metadata that automatically generates a documentation page about
        our component.
        <br />
        <br />
        <strong>
          Go to the stories file and add in the metadata object: <br />
          tags: ["autodocs"],
        </strong>
        <br />
        <br />
        Go to Storybook, check the folder EvolutionButton to find the file
        'Docs'. In this file you can now find each state of the button and its
        code.
      </p>
    </div>
  );
